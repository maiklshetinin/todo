...
interface IProps {
  id: 'delete' | 'add' | 'clip' | 'remove' | 'color';
}

export const SvgSelector: React.FC<IProps> = ({ id }) => {
  switch (id) {
    case 'delete':
      return (
        <svg
    ...
    case 'color':
      return (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <path d="M716.288 140.501333a42.666667 42.666667 0 0 1 60.373333 0l90.496 90.496a42.666667 42.666667 0 0 1 0 60.330667l-120.661333 120.704L595.626667 261.12l120.661333-120.661333zM520.192 185.770667l301.696 301.653333-60.330667 60.373333-301.653333-301.696 60.288-60.330666z" />
          <path d="M580.565333 366.762667l-60.373333-60.330667-362.026667 362.026667V853.333333l181.034667-3.84 362.026667-362.026666-60.330667-60.373334-331.861333 331.904-60.373334-60.373333 331.904-331.861333z" />
        </svg>
      );
    default:
      return null;
